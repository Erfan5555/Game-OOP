   ...
   check_point= check_point+1; // used to recoginse the game progression 
    ...
    while (while_stopper==1 && check[check_point]!=1) // waits until the correct input has been made
        if (*answer=='y' && answer[1]==0 ){ // if answer is yes it will cause ceratin changes 
            ...
            w->set_weatlh(46);
            p->change_entertainment(20);
            c->change_wealth_of_pop(45);
             update_stats(p,c,w,a);
            check_end_game(p,c,w,a);
            check_point_input(check,check_point); 
   ...
   if (check[check_point]!=1){ // checks if the user was at this point when they left the game
    ...
    while (while_stopper==1 && check[check_point]!=1) // waits until the correct input has been made
        if (*answer=='y' && answer[1]==0 ) { // if answer is yes it will cause ceratin changes 
            ...
            p->change_employment(3);
            p->change_food_avaliable(1);
            a->change_num_of_troops(38);
            p->change_entertainment(3);
            a->change_available_food(14);
            a->change_quality_of_weapons(6);
...
check_point=-1;
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        if (*answer=='y' && answer[1]==0 ) { // if answer is yes it will cause ceratin changes 
            c->change_number_of_churches(3);
            c->change_wealth_of_pop(20);
            c->set_king_popularity(10);
            w->set_weatlh(70);
            a->change_num_of_troops(50);
            p->change_food_avaliable(20);
            update_stats(p,c,w,a);
            check_end_game(p,c,w,a);
        check_point_input(check,check_point); 
            ...
            c->set_king_popularity(13);
            c->change_number_of_churches(10);
            c->change_wealth_of_pop(42);
            p->change_food_avaliable(12);
            p->change_employment(15);
            p->change_entertainment(40);
             update_stats(p,c,w,a);
            check_end_game(p,c,w,a);
            check_point_input(check,check_point); 
...
check_point=-1;
    ...
    while_stopper=1;
        if (check[check_point]!=1){
             mat.speak("Rumors say that a deamon is learking can the Army investigate?");
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        check_point_input(check,check_point); 
            ...
            p->change_entertainment(5);
            w->set_weatlh(54);
            c->set_king_popularity(10);
            c->change_number_of_churches(7);
             update_stats(p,c,w,a);
            check_end_game(p,c,w,a);
            check_point_input(check,check_point); 
...
check_point=-1;
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        if (*answer=='y' && answer[1]==0 ) { // if answer is yes it will cause ceratin changes 
          p->Rebel();
          a->set_king_popularity(25);
          a->change_quality_of_weapons(15);
          a->change_num_of_troops(30);
          c->set_king_popularity(10);
...
check_point=-1;
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        if (*answer=='y' && answer[1]==0 ) { // if answer is yes it will cause ceratin changes 
          w->set_weatlh(20);
          a->change_num_of_troops(20);
          c->change_wealth_of_pop(30);
            update_stats(p,c,w,a);
            check_end_game(p,c,w,a);
        check_point_input(check,check_point); 
...
check_point=-1;
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        check_point_input(check,check_point); 
           ...
           w->set_weatlh(52);
           a->change_available_food(25);
           c->set_king_popularity(20);
...
check_point=-1;
    ...
    while (while_stopper==1 && check[check_point]!=1 ) // waits until the correct input has been made
        ...
        if (*answer=='y' && answer[1]==0 ) { // if answer is yes it will cause ceratin changes 
          a->change_available_food(20);
          a->change_num_of_troops(35);
          a->change_quality_of_weapons(15);
